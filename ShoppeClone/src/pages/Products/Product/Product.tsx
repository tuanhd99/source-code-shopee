...
import { formatShopeeSalesCount, formattedCurrency, generateNameId } from "src/utils/function";
...
function Product({ prod }: IProps) {
  return (
    <Link to={`${RouterPath.Index}${generateNameId({ name: prod.name, id: prod._id })}`}>
